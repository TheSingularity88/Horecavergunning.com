...
export default function CasesPage() {
  ...
  const statusOptions = getCaseStatusOptions(t.dashboard, true);
  const typeOptions = getCaseTypeOptions(t.dashboard, true);
  ...
  return (
    <DashboardPage title={t.dashboard?.nav?.cases || 'Cases'}>
      <motion.div
