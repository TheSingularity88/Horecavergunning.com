  ...
  en: {
    ...
    dashboard: {
      nav: {
        ...
        ai: "AI employees",
        aiActivity: "AI activity & costs",
        aiKeys: "Agent API keys",
      ...
      aiKeys: {
        ...
        intro:
          "Keys you hand to an outside agent — a ChatGPT Custom GPT, or Claude Code — so it can work as one of your route 2 AI employees. These are the opposite of the provider keys on the AI employees page: those are keys you buy and we spend calling a model; these are keys you give away, and somebody else's agent spends them calling us. A key acts as its AI employee and never as an administrator, and anything a customer could see still waits for a human in the review queue.",
        backToEmployees: "Back to AI employees",
        listTitle: "Keys",
        mint: "Create key",
        noKeys: "No keys yet.",
        noEligibleEmployees:
          "You have no AI employee on route 2 yet. Create one under AI employees first — a key can only belong to an employee that works through its own API key.",
        employeeLabel: "Acts as",
        labelLabel: "Label",
        labelPlaceholder: "e.g. Nova in Claude Code",
        labelHint: "Name the tool that will hold this key, so you know which one to revoke later.",
        scopesLabel: "Permissions",
        scopeRead: "Read",
        scopeReadHint: "See leads, cases, tasks, clients and document names. Never file contents.",
        scopeWrite: "Change internal work",
        scopeWriteHint: "Update tasks, lead statuses and client records. Nothing a customer can see.",
        scopePropose: "Propose (needs approval)",
        scopeProposeHint: "File proposals for anything a customer can see. A human still approves each one.",
        expiryLabel: "Valid for (days)",
        expiryHint: "Keys always expire. Ninety days is a sensible default; a year is the maximum.",
        showOnceTitle: "Copy \"{label}\" now — it is not shown again.",
        showOnceHint:
          "We store only a one-way hash of this key, so nobody — including us — can show it to you again. Lose it and you create a new one.",
        copy: "Copy",
        copied: "Copied",
        copyFailed: "Copying failed. Select the key above and copy it by hand before you close this.",
      ...
      ai: {
        ...
        resume: "Resume",
        pausedBadge: "Paused",
        manageAgentKeys: "Agent API keys (route 2)",
        routeLabel: "Route",
  ...
  nl: {
    ...
    dashboard: {
      nav: {
        ...
        ai: "AI-medewerkers",
        aiActivity: "AI-activiteit & kosten",
        aiKeys: "API-sleutels agents",
      ...
      aiKeys: {
        title: "API-sleutels voor agents",
        intro:
          "Sleutels die u aan een externe agent geeft — een ChatGPT Custom GPT of Claude Code — zodat die kan werken als een van uw route 2-AI-medewerkers. Dit is het omgekeerde van de providersleutels op de pagina AI-medewerkers: die koopt u en verbruiken wij om een model aan te roepen; deze geeft u weg, en de agent van een ander verbruikt ze om ons aan te roepen. Een sleutel handelt als zijn AI-medewerker en nooit als beheerder, en alles wat een klant kan zien wacht nog steeds op een mens in de beoordelingswachtrij.",
        backToEmployees: "Terug naar AI-medewerkers",
        listTitle: "Sleutels",
        mint: "Sleutel aanmaken",
        noKeys: "Nog geen sleutels.",
        noEligibleEmployees:
          "U heeft nog geen AI-medewerker op route 2. Maak er eerst een aan bij AI-medewerkers — een sleutel kan alleen horen bij een medewerker die via zijn eigen API-sleutel werkt.",
        employeeLabel: "Handelt als",
        labelLabel: "Label",
        labelPlaceholder: "bijv. Nova in Claude Code",
        labelHint: "Noem de tool die deze sleutel krijgt, zodat u later weet welke u moet intrekken.",
        scopesLabel: "Rechten",
        scopeRead: "Lezen",
        scopeReadHint: "Leads, dossiers, taken, klanten en documentnamen inzien. Nooit de inhoud van bestanden.",
        scopeWrite: "Intern werk wijzigen",
        scopeWriteHint: "Taken, leadstatussen en klantgegevens bijwerken. Niets wat een klant kan zien.",
        scopePropose: "Voorstellen (met goedkeuring)",
        scopeProposeHint: "Voorstellen indienen voor alles wat een klant kan zien. Een mens keurt elk voorstel goed.",
        expiryLabel: "Geldig (dagen)",
        expiryHint: "Sleutels verlopen altijd. Negentig dagen is een verstandige standaard; een jaar is het maximum.",
        showOnceTitle: "Kopieer \"{label}\" nu — u krijgt hem niet nog een keer te zien.",
        showOnceHint:
          "Wij bewaren alleen een onomkeerbare hash van deze sleutel, dus niemand — ook wij niet — kan hem u opnieuw tonen. Kwijt is kwijt: dan maakt u een nieuwe aan.",
        copy: "Kopiëren",
        copied: "Gekopieerd",
        copyFailed: "Kopiëren is mislukt. Selecteer de sleutel hierboven en kopieer hem handmatig voordat u dit sluit.",
        savedIt: "Ik heb hem opgeslagen",
        expiresOn: "Verloopt {date}",
        lastUsed: "laatst gebruikt {date}",
        neverUsed: "nooit gebruikt",
        requestCount: "{n} verzoeken",
        statusActive: "Actief",
      ...
      ai: {
        ...
        manageAgentKeys: "API-sleutels voor agents (route 2)",
        routeLabel: "Route",
